...
public class Gadgets_setInventory {
    ...
    public void setInventory() {
        player.getInventory().setItem(0, new ItemAPI("§6§lTeleporter", Material.COMPASS, (byte) 0, 1).build());
        ...
        player.getInventory().setItem(8, new ItemAPI("§6§lDein Profil", player.getName(), 1).buildSkull());
